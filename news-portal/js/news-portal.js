...
const fetchCategoryNews = (category_id, category_name) => {
    ...
    fetch(url)
        ...
        .then(data => {
            fetchData = data.data;
            displayAllNewses(data.data, category_name)
        })
}

const displayAllNewses = (data, category_name) => {
    ...
    data.forEach(singleNews => {
        ...
        <div class="row g-0">
            ...
            <div class="col-md-8 d-flex flex-column">
              ...
              <p class="m-0 p-0">${total_view ? singleNews.total_view : "Not available"}</p>
              </div>
              <div class="d-flex gap-2">
...
const showTrending=()=>{
    ...
    displayAllNewses(trendingNews, category_name);
